...
export type EditSkillFormValues = z.infer<typeof formSchema>
...
const onSubmit = async (data:EditSkillFormValues) => {
  try {
    setLoading(true);
    
  
    await axios.patch(`/api/skills/${skill.id}`, data)
          ...
          render={({ field }) => (
            <FormItem className="flex flex-col">
              ...
              <FormLabel className="text-xs text-muted-foreground flex justify-between px-2">
                Current Name: <p className="font-semibold text-emerald-800 dark:text-emerald-500">{skill?.name}</p>
              </FormLabel>
              <FormControl>
               <Input 
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="flex flex-col">
              ...
              <FormLabel className="text-xs text-muted-foreground flex justify-between px-2">
                Current Experience: <p className="font-semibold text-emerald-800 dark:text-emerald-500 pl-2"> {skill?.experience}</p>
              </FormLabel>
              <FormControl>
                 <Input
                  type='text'
        ...
        <div className="w-full">
          ...
          render={({ field }) => (
            <FormItem className="flex flex-col">
              ...
              <FormLabel className="text-xs text-muted-foreground flex justify-between px-2">
                Current Description: <p className="font-semibold text-emerald-800 dark:text-emerald-500 pl-2"> {skill?.description}</p>
              </FormLabel>
              <FormControl>
