...
export type EditStudentProfileFormValues = z.infer<typeof formSchema>

const EditStudentProfileForm = ({
  profile,
  onClose,
}:EditStudentProfileFormProps) => {
...
const onSubmit = async (data:EditStudentProfileFormValues) => {
  try {
    setLoading(true);
    
  
    await axios.patch(`/api/profiles/${profile.id}`, data)
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="flex flex-col">
              ...
              <FormLabel className="text-xs text-muted-foreground flex justify-between px-2">
                Current Email: <p className="font-semibold text-emerald-800 dark:text-emerald-500 pl-2"> {profile?.email}</p>
              </FormLabel>
              <FormControl>
        ...
        <div className="w-full">
          ...
          render={({ field }) => (
            <FormItem className="flex flex-col">
              ...
              <FormLabel className="text-xs text-muted-foreground flex justify-between px-2">
                Current About: <p className="font-semibold text-emerald-800 dark:text-emerald-500 pl-2"> {profile?.about}</p>
              </FormLabel>
              <FormControl>
